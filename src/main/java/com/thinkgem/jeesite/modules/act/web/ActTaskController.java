...
public class ActTaskController extends BaseController {
	...
	public String todoList(AccountRequisitionAct entity, HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
		...
		entity.setCheckerName(user.getId());
		entity.setState(0);
		Page<Map<String,Object>> page=accountRequisitionActService.findPage(new Page<Map<String,Object>>(request, response),entity);
	...
	public String historicList(AccountRequisitionAct entity,  HttpServletRequest request,HttpServletResponse response, Model model) throws Exception {
