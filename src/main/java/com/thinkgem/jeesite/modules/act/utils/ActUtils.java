...
//	private static Logger logger = LoggerFactory.getLogger(ActUtils.class);
	...
	public static final String[] PD_TEST_PURCHASE = new String[]{"test_purchase", "account_purchase"};
	public static final String[] PD_REQUISITION_PRO= new String[]{"requisition_pro", "account_requisition"};
//	/**
//	 * 流程定义Map（自动初始化）
//	 */
