...
<body>
	...
	<form:form id="inputForm" modelAttribute="accountPurchase" action="${ctx}/erp/accountPurchase/" method="post" class="form-horizontal">
		<form:hidden path="id"/>
				...
				<div class="controls">
					...
					<script type="text/template" id="accountPurchaseDetailTpl">//<!--
						<tr id="accountPurchaseDetailList{{idx}}">
							...
							<td>
								<input id="accountPurchaseDetailList{{idx}}_receivedate" readonly name="accountPurchaseDetailList[{{idx}}].receivedate" type="text" value="{{row.receivedate}}"  class="input-small "/>
