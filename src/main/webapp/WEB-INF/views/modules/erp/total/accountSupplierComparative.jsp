...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/erp/accountPurchaseComparative/comparative">物资</a></li>
		 <li><a href="${ctx}/erp/accountPurchaseComparative/supplierComparative">供应商</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="accountSupplierComparative" action="${ctx}/erp/accountPurchaseComparative/comparative" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead >
			<tr>
				<th rowspan="2">物资编码</th>
				<th colspan="2">物资名称</th>
				<th colspan="2">物资型号</th>
		...
		<c:forEach items="${page.list}" var="comparative">
			<tr>
				<td>
					...
					${comparative.materialcode} 
				</td>
				<td colspan="2">
					${comparative.materialname} 
				</td>
				<td colspan="2">
					${comparative.size} 
				</td>
				...
				<td colspan="2" class="totalmoney">
					${comparative.totalmoney+comparative.freightfee}
					<c:set var="total" value="${total + comparative.freightfee+comparative.totalmoney}"></c:set>
				</td>
				<td colspan="2">
