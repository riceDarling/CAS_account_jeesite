...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/erp/accountRejectTotal/rejectRate">物资</a></li>
		<li><a href="${ctx}/erp/accountRejectTotal/rejectRateSuppliers">供应商</a></li>
	</ul><br/>
	<form:form id="searchForm" modelAttribute="accountRejectTotalRejectRate" action="${ctx}/erp/accountRejectTotal/rejectRate" method="post" class="breadcrumb form-search">
