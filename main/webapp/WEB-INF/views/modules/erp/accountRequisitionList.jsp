		...
		<ul class="ul-form">
			...
			<li><label>更新时间：</label>
				<input name="updateDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate"
					value="<fmt:formatDate value="${accountRequisition.updateDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="accountRequisition">
			<tr>
				...
				<td>
					<fmt:formatDate value="${accountRequisition.updateDate}" pattern="yyyy-MM-dd HH:mm:ss"/>
				</td>
				<td>
